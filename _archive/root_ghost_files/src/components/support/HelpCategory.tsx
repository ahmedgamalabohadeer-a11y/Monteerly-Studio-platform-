...
export function HelpCategory({ icon: Icon, title, desc, articles }: HelpProps) {
  return (
    <div className="bg-slate-900 border border-white/10 rounded-xl p-6 hover:border-indigo-500/30 transition-all group">
