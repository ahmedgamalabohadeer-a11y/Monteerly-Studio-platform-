    ...
    <div className={`min-h-screen transition-colors duration-700 font-sans ${isDarkMode ? 'bg-[#05050A] text-slate-50' : 'bg-slate-50 text-slate-900'} selection:bg-indigo-500/30 overflow-x-hidden`} dir={isAr ? 'rtl' : 'ltr'}>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-16 md:h-20 flex items-center justify-between">
          <div className="flex items-center gap-2 md:gap-8">
            ...
            <div className="hidden md:flex items-center gap-6 font-bold text-sm">
              <Link href="#ecosystem" className="hover:text-indigo-500 transition-colors">{isAr ? 'المنظومة' : 'Ecosystem'}</Link>
              <Link href="#library" className="hover:text-indigo-500 transition-colors">{isAr ? 'المكتبة' : 'Library'}</Link>
              <Link href="#pricing" className="hover:text-indigo-500 transition-colors">{isAr ? 'الأسعار' : 'Pricing'}</Link>
            </div>
          </div>

          <div className="flex items-center gap-2 md:gap-4">
            <button onClick={toggleLanguage} className={`font-bold text-xs md:text-sm px-2 py-1 md:px-3 md:py-1.5 rounded-lg transition-colors ${isDarkMode ? 'hover:bg-slate-800 text-slate-300' : 'hover:bg-slate-200 text-slate-700'}`}>{t.nav?.lang || (isAr ? 'English' : 'عربي')}</button>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-24 pb-12 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <Image src="/images/monteerly/monteerly_04_hero_header_marketing_banner.png" alt="Hero" fill priority className="object-cover opacity-50 scale-105 mix-blend-overlay" />
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            <div className={`col-span-1 lg:col-span-2 p-6 md:p-12 rounded-3xl md:rounded-[2.5rem] border overflow-hidden relative group flex flex-col justify-between min-h-[350px] md:min-h-[450px] ${isDarkMode ? 'bg-[#0A0A0F] border-white/10' : 'bg-white border-slate-200'}`}>
              ...
              <div className="relative z-10 -mx-6 -mb-6 md:-mx-12 md:-mb-12 mt-auto">
                <Image src="/images/monteerly/monteerly_06_marketing_showcase_full.png" alt="Academy" width={600} height={400} className="w-full h-40 md:h-56 object-cover object-top opacity-80" />
              </div>
            </div>
      ...
      <footer className={`py-12 md:py-16 px-4 border-t relative z-20 ${isDarkMode ? 'bg-[#030305] border-white/5' : 'bg-slate-100 border-slate-200'}`}>
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-2">
             <Image src="/images/monteerly/monteerly_02_main_logo_full.svg" alt="MCOS" width={150} height={40} className="mb-4 opacity-90" />
...
print("✅ تم حقن مسارات الصور الحقيقية المستخرجة مباشرة في الكود!")
