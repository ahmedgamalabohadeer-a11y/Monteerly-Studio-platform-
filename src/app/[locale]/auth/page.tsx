...
export default function AuthGateway() {
  ...
  return (
    <div className="min-h-screen bg-[#05050A] flex font-sans text-slate-50" dir="rtl">
      {/* العمود الأيسر: نموذج الدخول / التسجيل */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 z-10 relative">
        <button
          onClick={() => router.push('/ar')}
          className="absolute top-8 right-8 text-slate-400 hover:text-white flex items-center gap-2 transition-colors"
        >
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-10">
            ...
            <h1 className="text-4xl font-black text-white mb-2">
              {isLogin ? 'بوابة العبور' : 'تأسيس الهوية السيادية'}
            </h1>
            <p className="text-slate-400 text-sm">
              Monteerly OS - حيث تلتقي النخب الإبداعية بالقوة التقنية.
            </p>
          </div>
          ...
          {msg.text && (
            <div
              className={`p-4 rounded-xl mb-6 border text-sm font-bold flex items-center gap-2 animate-in fade-in ${
                msg.type === 'success'
          ...
          <div className="relative flex items-center justify-center mb-6">
            ...
            <span className="bg-[#05050A] px-4 text-xs text-slate-500 font-bold absolute">
              أو عبر البريد المشفر
            </span>
          </div>

          {/* نموذج البريد / كلمة المرور + الدور */}
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            >
              {loading ? (
                ...
                'تأمين الاتصال والدخول'
              ) : (
                'تأسيس الهوية السيادية'
              )}
            </button>
          </form>

          {/* تبديل بين الدخول / التسجيل */}
          <div className="mt-8 text-center text-sm text-slate-400">
            ...
            <button
              ...
              className="text-indigo-400 font-bold mr-2 hover:text-indigo-300"
            >
      ...
      {/* العمود الأيمن: سرد لقيمة Escrow والأمان */}
      <div className="hidden lg:flex w-1/2 bg-[#0A0A0F] border-r border-white/5 relative overflow-hidden items-center justify-center">
        <div className="absolute inset-0 bg-gradient-to-tr from-indigo-900/20 to-purple-900/20 mix-blend-screen" />
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=2000&auto=format&fit=crop')] opacity-[0.05] bg-cover bg-center mix-blend-overlay" />

        <div className="relative z-10 max-w-lg p-12">
          <h2 className="text-4xl font-black text-white leading-tight mb-6">
            احمِ إبداعك،
            <br /> <span className="text-indigo-400">وثّق حقوقك.</span>
          </h2>
