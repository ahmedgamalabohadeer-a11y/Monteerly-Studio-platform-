...
import { Wallet, ArrowUpRight, ArrowDownRight, Clock, ShieldCheck, DollarSign, Loader2, AlertTriangle, Lock } from 'lucide-react';
...
export default function WalletPage() {
  ...
  // تحديث حالة الرصيد لتشمل "قيد التخليص" بناءً على دستور الـ 48 ساعة
  const [balance, setBalance] = useState({ available: 1250.00, clearing: 300.00, pending_escrow: 450.00, total_earned: 8900.00 });
        ...
        {balance.clearing > 0 && (
           <div className="bg-amber-500/10 border border-amber-500/20 rounded-[2rem] p-6 mb-8 flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                 ...
                 <div>
                    <h4 className="font-bold text-amber-400">أموال قيد التخليص האمني (Clearing)</h4>
