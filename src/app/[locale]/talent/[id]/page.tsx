  ...
  return (
    <div className="min-h-screen bg-[#05050A] text-slate-50 font-sans pt-20 pb-20" dir="rtl">
      ...
      <div className="h-64 md:h-80 w-full relative">
        ...
        <Image
          src={MCOS_ASSETS.workspace.timeline.src}
          alt="غلاف ملف المبدع"
          fill
          sizes="100vw"
          priority
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-20 -mt-24 md:-mt-32">
        <div className="flex flex-col md:flex-row items-center md:items-end gap-6 mb-12">
          <div className="relative w-40 h-40">
            <Image
              src={MCOS_ASSETS.market.arabEditor.src}
              alt="صورة أحمد جمال"
              fill
              sizes="160px"
              className="rounded-[2rem] object-cover border-4 border-[#05050A] shadow-2xl"
            />
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  MCOS_ASSETS.heritageAndLibrary.cityDrone.src,
                  MCOS_ASSETS.heritageAndLibrary.saudiTraditional.src,
                  MCOS_ASSETS.workspace.dualScreen.src,
                  MCOS_ASSETS.techAndAi.advisor.src
                ].map((img, i) => (
                  <div key={i} className="relative h-48 rounded-2xl overflow-hidden group cursor-pointer border border-white/5">
                    ...
                    <Image
                      src={img}
                      alt={`عمل رقم ${i + 1} في معرض الأعمال`}
                      fill
