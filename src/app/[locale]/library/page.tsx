...
import { PlayCircle, Film, Camera, Filter, ShoppingCart, ShieldCheck } from 'lucide-react';
            ...
            <div key={asset.id} className="bg-[#0A0A0F] border border-white/5 rounded-[2rem] overflow-hidden group hover:border-rose-500/50 hover:shadow-[0_0_30px_rgba(225,29,72,0.15)] transition-all flex flex-col">
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <div className="flex justify-between items-center mt-auto pt-4 border-t border-white/5">
                  ...
                  <button
                    className="bg-[#12121A] border border-white/5 hover:bg-rose-600 text-slate-300 hover:text-white p-2.5 rounded-xl transition-all"
                    aria-label={`إضافة ${asset.title} إلى السلة`}
                  >
