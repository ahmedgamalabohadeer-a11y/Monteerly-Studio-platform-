...
import { UploadCloud, UserPlus, FolderPlus, Film, type LucideIcon } from 'lucide-react';
...
function ActionCard({ icon: Icon, title, desc, primary = false }: ActionCardProps) {
  return (
    <button
      type="button"
      className={`flex flex-col items-center p-6 rounded-xl border transition-all hover:scale-105 hover:shadow-lg group ${
        primary
