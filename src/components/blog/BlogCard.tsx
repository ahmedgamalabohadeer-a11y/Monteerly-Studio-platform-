  ...
  return (
    <div className="group bg-slate-900 border border-white/10 rounded-2xl overflow-hidden hover:border-indigo-500/50 transition-all hover:-translate-y-1">
      ...
      <div className="p-6">
        ...
        <p className="text-slate-400 text-sm mb-6 line-clamp-2">{excerpt}</p>

        <Link href={`/blog/${slug}`}>
          <Button
            variant="outline"
            className="w-full border-white/10 text-white hover:bg-white/10 group-hover:border-indigo-500/30"
          >
            اقرأ المزيد{' '}
