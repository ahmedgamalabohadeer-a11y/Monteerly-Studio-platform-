    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="bg-card w-full max-w-lg rounded-2xl p-6 shadow-2xl animate-in zoom-in-95">
        ...
        <p className="text-sm text-muted-foreground mb-6">
          السعر الأصلي للعميل هو{' '}
          <span className="font-bold text-foreground">${originalPrice}</span>. ما هو اقتراحك؟
        </p>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <textarea
              className="w-full h-24 p-3 bg-muted/30 border border-border rounded-xl resize-none text-sm"
              placeholder="أحتاج لزيادة السعر لأن المشروع يتطلب..."
            />
          </div>
        </div>
