...
// تم استخدام مسار ديناميكي لضمان عمل الصورة أينما كان المكون
const logo = '/images/monteerly/monteerly_02_main_logo_full.svg';
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative h-10 w-10 transition-transform group-hover:scale-105">
                 <Image src={logo} alt="Monteerly OS" width={40} height={40} className="object-contain h-10 w-auto" />
              </div>
