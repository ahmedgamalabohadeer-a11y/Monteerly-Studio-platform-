        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1 leading-relaxed">
              أنت تحاول رفع{' '}
              <span className="font-mono font-bold text-foreground bg-muted px-1 rounded">
                {fileName}
              </span>
              ، ولكن يوجد ملف بنفس الاسم في هذا المجلد.
            </p>
          </div>
        </div>
          ...
          >
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground">
                سيتم تسمية الملف الجديد بصيغة مشابهة مثل: {fileName} (1)
              </div>
            </div>
          </button>
