    ...
    <div className="space-y-6">
          ...
          {keys.map((key) => (
            <div key={key.id} className="bg-black/40 border border-white/5 p-4 rounded-xl flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button className="p-2 hover:bg-white/10 rounded text-slate-400 hover:text-white" title="Roll Key">
                  <RefreshCw size={14} />
                </button>
                <button className="p-2 hover:bg-red-500/10 rounded text-slate-400 hover:text-red-400" title="Revoke">
                  <Trash2 size={14} />
                </button>
              </div>
            </div>
      ...
      <div className="bg-indigo-900/20 border border-indigo-500/30 rounded-xl p-6">
        ...
        <div className="bg-black p-3 rounded-lg border border-white/10 font-mono text-xs text-green-400 flex justify-between items-center">
          <span>curl [https://api.monteerly.com/v1/projects](https://api.monteerly.com/v1/projects) -u sk_live_...:</span>
          <Copy size={12} className="cursor-pointer hover:text-white" />
        </div>
        <div className="mt-4">
          <a href="#" className="text-xs text-white font-bold underline hover:text-indigo-400">
