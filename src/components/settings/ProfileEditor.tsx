       ...
       <div className="relative">
          ...
          <div className="absolute -bottom-12 right-8 flex items-end">
             <div className="w-24 h-24 bg-black rounded-2xl p-1 relative group cursor-pointer">
                <img src="/avatars/mohamed.jpg" className="w-full h-full rounded-xl object-cover" />
             ...
             <div className="bg-slate-900 border border-white/10 rounded-xl p-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                   <div>
                      ...
                      <input type="text" defaultValue="محمد" className="w-full bg-black/30 border border-white/10 rounded-lg p-3 text-white focus:border-indigo-500 outline-none" />
                   </div>
                   <div>
                      <label className="text-xs text-slate-400 block mb-1">اسم العائلة</label>
                      <input type="text" defaultValue="كمال" className="w-full bg-black/30 border border-white/10 rounded-lg p-3 text-white focus:border-indigo-500 outline-none" />
                   </div>
                </div>
                <div className="mb-4">
                   <label className="text-xs text-slate-400 block mb-1">المسمى الوظيفي</label>
                   <input type="text" defaultValue="Senior Video Editor" className="w-full bg-black/30 border border-white/10 rounded-lg p-3 text-white focus:border-indigo-500 outline-none" />
                </div>
                <div>
                   <label className="text-xs text-slate-400 block mb-1">النبذة التعريفية (Bio)</label>
                   <textarea className="w-full bg-black/30 border border-white/10 rounded-lg p-3 text-white focus:border-indigo-500 outline-none h-24 resize-none" defaultValue="محرر فيديو شغوف بخبرة 7 سنوات..." />
                </div>
             </div>
             ...
             <div className="bg-slate-900 border border-white/10 rounded-xl p-6">
                ...
                <div className="space-y-3">
                   <div className="flex items-center gap-2 bg-black/30 p-2 rounded-lg border border-white/5">
                      ...
                      <input type="text" defaultValue="القاهرة، مصر" className="bg-transparent text-sm text-white outline-none w-full" />
                   </div>
                   <div className="flex items-center gap-2 bg-black/30 p-2 rounded-lg border border-white/5">
                      <Globe size={16} className="text-slate-500" />
                      <input type="text" defaultValue="behance.net/mohamed" className="bg-transparent text-sm text-white outline-none w-full" />
                   </div>
                </div>
             </div>
          </div>
