...
import { Download, Trash2, Database, FileJson } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
       <div className="border-l-4 border-blue-500 pl-4 py-1">
          ...
          <p className="text-sm text-muted-foreground">نحن نلتزم بمعايير GDPR و CCPA لحماية خصوصيتك.</p>
       </div>
       ...
       <div className="bg-card border border-border rounded-xl p-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <Button variant="outline" icon={<Download size={16} />}>طلب الأرشيف</Button>
       </div>
       ...
       <div className="bg-red-50/50 border border-red-100 rounded-xl p-6">
          ...
          <Button variant="danger" size="sm">بدء إجراءات الحذف</Button>
       </div>
    </div>
  );
}
