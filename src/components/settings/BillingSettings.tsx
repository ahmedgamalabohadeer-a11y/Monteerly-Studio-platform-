...
import { Check, Download, Zap, AlertTriangle, Plus } from 'lucide-react';
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-indigo-200 text-sm mb-4">
              يتم التجديد في 15 فبراير 2026 • $19/شهرياً
            </p>
            <div className="flex gap-2 text-xs text-slate-300">
              <span className="flex items-center gap-1">
                <Check size={12} className="text-green-400" /> مساحة 1TB
              </span>
              <span className="flex items-center gap-1">
                <Check size={12} className="text-green-400" /> 4K Export
              </span>
              <span className="flex items-center gap-1">
                <Check size={12} className="text-green-400" /> بدون علامة مائية
              </span>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <Button className="bg-white text-indigo-900 font-bold hover:bg-slate-200">
              ترقية للخطة المؤسسية
            </Button>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-4 bg-black/20 border border-white/5 rounded-xl">
            <div className="flex items-center gap-4">
              <div className="w-10 h-6 bg-slate-200 rounded flex items-center justify-center overflow-hidden">
                <Image
          ...
          <div className="flex items-center justify-between p-4 bg-black/20 border border-white/5 rounded-xl opacity-60">
            <div className="flex items-center gap-4">
              <div className="w-10 h-6 bg-blue-600 rounded flex items-center justify-center text-white font-bold text-[8px]">
                VISA
              </div>
              <div>
