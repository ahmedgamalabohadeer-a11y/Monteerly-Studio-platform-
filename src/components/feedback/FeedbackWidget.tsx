...
import { MessageSquare, Camera, Mic, X, Send, ThumbsUp, AlertCircle, Check, Loader2 } from 'lucide-react';
...
export function FeedbackWidget() {
  ...
  const takeScreenshot = () => {
    ...
    setTimeout(() => {
      setIsOpen(true);
      setScreenshot('/images/features/live.jpg');
    }, 500);
  };
              ...
              {sent ? (
                ...
                <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-y-auto">
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className={`flex-1 py-3 rounded-xl border border-dashed flex flex-col items-center justify-center gap-1 transition-colors ${
                          screenshot
                    ...
                    {screenshot && (
                      <div className="relative rounded-lg overflow-hidden border border-white/10 group">
                        <div className="relative w-full h-24">
                          <Image
                            src={screenshot}
                            alt="معاينة لقطة الشاشة المرفقة مع الملاحظات"
                            fill
                  ...
                  <div className="p-4 border-t border-white/10 bg-[#1a1a1a] mt-auto">
                    <InteractiveButton type="submit" loading={sending} className="w-full" icon={<Send size={16} />}>
