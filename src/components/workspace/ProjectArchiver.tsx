...
import { Archive, Download, FileCode, Film, Music, type LucideIcon } from 'lucide-react';
...
function ExportOption({ title, size, icon: Icon, selected, onToggle }: ExportOptionProps) {
  return (
    <div
       onClick={onToggle}
