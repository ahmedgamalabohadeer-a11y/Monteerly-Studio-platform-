    ...
    <div className="bg-black rounded-xl overflow-hidden border border-border">
       <div className="grid grid-cols-2 gap-1 relative">
          ...
          <div className="relative group">
             ...
             <video ref={rightVideo} src={rightSrc} className="w-full aspect-video bg-slate-900" muted />
          </div>
       ...
       <div className="bg-slate-900 p-4 flex items-center gap-4 text-white">
          ...
          <button
            onClick={() => {
              if (leftVideo.current) leftVideo.current.currentTime = 0;
              if (rightVideo.current) rightVideo.current.currentTime = 0;
            }}
