  ...
  const shots = [
    {
      ...
      lens: '24mm',
      angle: 'Eye Level',
      desc: 'Establishing shot of the cafe.',
      status: 'Done',
    },
    {
      id: '1B',
        ...
        <tbody className="divide-y divide-white/5">
          {shots.map((shot) => (
            <tr key={shot.id} className="hover:bg-white/5 transition-colors group">
              ...
              <td className="p-4 text-slate-400 text-xs">{shot.angle}</td>
