...
import { MapPin, Sun, CloudRain, Send, Users, User } from 'lucide-react';
import { Button } from '@/components/ui/Button';

export function CallSheetBuilder() {
  const weather = { temp: '24°C', condition: 'Sunny', icon: Sun };
        ...
        <div className="p-4 border-b border-black bg-slate-50">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <a href="#" className="text-xs text-blue-600 underline font-bold">
                Open in Maps
              </a>
            </div>
          </div>
            ...
            <tbody className="divide-y divide-slate-200">
              <tr>
                ...
                <td className="p-2">
                  INT. TENT - DAY
                  <br />
                  <span className="italic text-slate-500">Hero meets the wise man.</span>
                </td>
              ...
              <tr>
                ...
                <td className="p-2">
                  EXT. DESERT - SUNSET
                  <br />
                  <span className="italic text-slate-500">The journey begins.</span>
                </td>
