  ...
  const segments = [
    {
      ...
      original: 'Welcome to the future of editing.',
      translated: 'مرحباً بكم في مستقبل المونتاج.',
      status: 'approved',
    },
    {
      id: 2,
      ...
      original: 'Everything is cloud-based now.',
      translated: 'كل شيء أصبح سحابياً الآن.',
      status: 'approved',
    },
    {
      id: 3,
      ...
      original: 'No more expensive hardware needed.',
      translated: '',
      status: 'draft',
    },
  ];
      ...
      <div className="lg:col-span-1 flex flex-col gap-4">
        ...
        <div className="bg-slate-900 border border-white/10 rounded-xl p-4">
          ...
          <div className="space-y-3">
            ...
            <Button className="w-full mt-2 bg-indigo-600 text-white font-bold text-xs">
              توليد الدبلجة
            </Button>
          </div>
        </div>
      ...
      <div className="lg:col-span-2 bg-slate-900 border border-white/10 rounded-xl flex flex-col overflow-hidden">
        <div className="p-4 border-b border-white/10 bg-slate-950 flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <Button variant="outline" className="border-white/10 text-white text-xs">
              استيراد SRT
            </Button>
            <Button variant="outline" className="border-white/10 text-white text-xs">
              تصدير SRT
