        ...
        >
          ...
          <div className="p-4">
            ...
            <div className="flex gap-2 mb-4">
              <span className="text-[10px] bg-white/5 border border-white/10 px-2 py-1 rounded text-slate-300">
                {talent.type}
              </span>
              <span className="text-[10px] bg-white/5 border border-white/10 px-2 py-1 rounded text-slate-300">
                Arabic (Native)
            ...
            <div className="flex gap-2 pt-3 border-t border-white/5">
              <Button
                size="sm"
                variant="outline"
                className="flex-1 border-white/10 text-white text-xs gap-1"
              >
              ...
              <Button
                size="sm"
                variant="outline"
                className="w-8 px-0 border-white/10 text-slate-500 hover:text-red-400 hover:bg-red-500/10"
              >
                <XCircle size={14} />
              </Button>
            </div>
