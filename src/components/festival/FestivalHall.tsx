    ...
    <div className="min-h-screen bg-[#050505] text-white">
      <div className="relative h-[500px] w-full overflow-hidden">
        ...
        <Image
          ...
          alt="خلفية العرض الأول لفيلم THE LAST SAND"
          fill
          priority
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="bg-slate-900 border border-white/10 rounded-xl flex flex-col h-[500px]">
          ...
          <div className="p-3 border-t border-white/10 bg-slate-950 rounded-b-xl">
            <input
              type="text"
              placeholder="اشترِ تذكرة للمشاركة في الدردشة..."
              disabled
              className="w-full bg-slate-900 border border-white/10 rounded px-3 py-2 text-xs text-white cursor-not-allowed"
            />
          </div>
        </div>
      </div>
