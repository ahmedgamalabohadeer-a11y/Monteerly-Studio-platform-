    ...
    <div className="bg-white text-black rounded-xl p-6 shadow-2xl sticky top-24">
      ...
      <div className="space-y-3 mb-6">
        <div className="flex items-center gap-3 text-sm text-slate-700 bg-slate-100 p-3 rounded-lg">
          ...
          <span>
            وقت الرد: <strong>أقل من ساعة</strong>
          </span>
        </div>
        <div className="flex items-center gap-3 text-sm text-slate-700 bg-slate-100 p-3 rounded-lg">
          <CheckCircle size={16} className="text-slate-400" />
          <span>
            مشاريع مكتملة: <strong>142</strong>
          </span>
        </div>
      </div>
      ...
      <p className="text-center text-[10px] text-slate-400 mt-4">محمية بواسطة نظام Monteerly Escrow</p>
    </div>
  );
}
