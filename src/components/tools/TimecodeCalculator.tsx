      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <input
            ...
            className="w-full bg-background border border-input rounded-lg p-3 font-mono text-center text-lg tracking-widest outline-none focus:border-primary"
          />
          <input
            value={tc2}
        ...
        <div className="pt-4 border-t border-border text-center">
          ...
          <div className="text-3xl font-black font-mono text-primary tracking-widest">
            {result}
          </div>
        </div>
