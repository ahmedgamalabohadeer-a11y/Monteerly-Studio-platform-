...
import { Skull, Database, WifiOff } from 'lucide-react';
      ...
      <div className="bg-red-950/20 border border-red-500/30 rounded-xl p-6 relative overflow-hidden">
        ...
        <div className="space-y-4 relative z-10">
          <div className="flex items-center justify-between p-4 bg-black/40 border border-red-500/20 rounded-xl">
            ...
            <InteractiveButton variant="danger" size="sm" onClick={() => triggerChaos('DB_CRASH')}>
              EXECUTE
            </InteractiveButton>
          </div>
          ...
          <div className="flex items-center justify-between p-4 bg-black/40 border border-red-500/20 rounded-xl">
            ...
            <InteractiveButton variant="danger" size="sm" onClick={() => triggerChaos('NET_SPLIT')}>
              EXECUTE
            </InteractiveButton>
          </div>
        </div>
