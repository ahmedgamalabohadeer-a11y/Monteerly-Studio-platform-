...
export function SeoPreview() {
  ...
  const [desc, setDesc] = useState(
    'Join 10,000+ creators using the most advanced cloud editing platform in the world.'
  );
  const image = 'https://monteerly.com/og-image.jpg';
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div className="bg-slate-900 border border-white/10 rounded-xl p-6 space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full bg-black/30 border border-white/10 rounded p-2 text-white text-sm h-24"
          />
      ...
      <div className="space-y-6">
        <div className="bg-white p-4 rounded-xl shadow-lg">
          ...
          <div className="text-xl text-[#1a0dab] font-normal hover:underline cursor-pointer mb-1 truncate">
            {title}
          </div>
        ...
        <div className="bg-black border border-slate-800 rounded-xl overflow-hidden max-w-sm">
          <div
            className="h-40 bg-slate-800 bg-cover bg-center flex items-center justify-center text-slate-500 text-xs"
