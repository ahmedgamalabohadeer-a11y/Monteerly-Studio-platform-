...
import { Activity, Server, Cpu, ArrowUp } from 'lucide-react';
      ...
      <div className="lg:col-span-2 space-y-6">
        <div className="bg-slate-900 border border-white/10 rounded-xl p-6">
          ...
          <div className="h-48 flex items-end gap-1 overflow-hidden relative">
            <div className="absolute inset-0 border-t border-dashed border-red-500/30 top-[20%] text-[10px] text-red-500">
              Critical Threshold
            </div>
          ...
          {Array.from({ length: pods }).map((_, i) => (
            ...
            >
              ...
              <div className="w-full h-1 bg-slate-800 rounded-full overflow-hidden">
                <div className="h-full bg-green-500" style={{ width: `${((i * 13) % 80) + 20}%` }} />
              </div>
            </motion.div>
          ))}
