...
import { Wand2, Layers, ScanLine, Eraser, Palette } from 'lucide-react';
      ...
      <div className="lg:col-span-2 bg-black border border-white/10 rounded-xl relative overflow-hidden group select-none">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="نسخة مرممة من اللقطة التاريخية"
            fill
        ...
        >
          <Image
            src="/images/features/live.jpg"
            alt="النسخة الأصلية قبل الترميم"
            fill
            className="absolute inset-0 object-cover filter grayscale sepia contrast-125 brightness-75"
            sizes="(max-width: 1024px) 100vw, 66vw"
          />
          <div className="absolute inset-0 opacity-30 bg-[url('https://www.transparenttextures.com/patterns/scratch-pad.png')] mix-blend-screen pointer-events-none" />
        </div>
