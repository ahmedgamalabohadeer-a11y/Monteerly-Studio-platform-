      ...
      <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs">
                اكتشف كم ستوفر مع Monteerly Studio.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-black/40 border border-white/10 rounded-lg py-3 px-4 pl-10 text-white focus:border-indigo-500 outline-none"
              />
              <DollarSign
                size={16}
        ...
        <div className="flex-1 bg-gradient-to-br from-indigo-900 to-purple-900 rounded-xl p-8 text-center flex flex-col justify-center relative overflow-hidden">
          <div className="relative z-10">
            <h4 className="text-indigo-200 text-sm font-bold mb-6 uppercase tracking-wider">
