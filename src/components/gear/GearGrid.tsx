...
import { MapPin, Star, ShieldCheck, Filter } from 'lucide-react';
...
export function GearGrid() {
  const items = [
    ...
    },
    {
      ...
      rating: 5.0,
      image:
        'https://images.unsplash.com/photo-1527011046414-4781f1f94f8c?auto=format&fit=crop&w=400&q=80',
      owner: 'Ahmed Light',
    },
    {
      id: 3,
      ...
      rating: 4.8,
      image:
        'https://images.unsplash.com/photo-1589873098338-92794324fb7b?auto=format&fit=crop&w=400&q=80',
      owner: 'CamHouse',
    },
    {
      id: 4,
      ...
      rating: 4.7,
      image:
        'https://images.unsplash.com/photo-1564466021188-1e17010f5411?auto=format&fit=crop&w=400&q=80',
      owner: 'FilmGear',
    },
  ];
  ...
  return (
    <div>
      <div className="flex gap-4 mb-6 overflow-x-auto pb-2">
        <Button variant="outline" className="bg-white/5 border-white/10 text-white rounded-full text-xs gap-2">
          <Filter size={14} /> كل الفئات
        </Button>
        <Button variant="outline" className="bg-slate-900 border-white/10 text-slate-400 hover:text-white rounded-full text-xs">
          كاميرات
        </Button>
        <Button variant="outline" className="bg-slate-900 border-white/10 text-slate-400 hover:text-white rounded-full text-xs">
          عدسات
