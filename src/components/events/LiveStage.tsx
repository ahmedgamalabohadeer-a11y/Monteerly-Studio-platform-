    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[calc(100vh-140px)]">
       ...
       <div className="lg:col-span-2 flex flex-col">
          <div className="bg-black border border-white/10 rounded-xl overflow-hidden relative flex-1 mb-4">
             ...
             <div className="absolute top-4 right-4 bg-black/60 text-white px-3 py-1 rounded text-xs font-bold flex items-center gap-2">
             ...
             <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-slate-900 to-black">
                <div className="text-center">
                   <div className="w-24 h-24 rounded-full bg-indigo-600 flex items-center justify-center mx-auto mb-4 border-4 border-slate-800">
                      <img src="/avatars/mohamed.jpg" className="w-full h-full rounded-full object-cover" />
                   </div>
          ...
          <div className="bg-slate-900 border border-white/10 rounded-xl p-4 flex justify-between items-center">
             ...
             <div className="flex gap-3">
                <Button variant="outline" className="border-white/10 text-white hover:bg-white/5 gap-2"><Heart size={16}/> إعجاب</Button>
       ...
       <div className="lg:col-span-1 flex flex-col gap-4">
          ...
          <div className="flex-1 bg-slate-900 border border-white/10 rounded-xl flex flex-col overflow-hidden">
             <div className="p-3 border-b border-white/10 bg-slate-950 font-bold text-white text-sm">المحادثة المباشرة</div>
             ...
             <div className="p-3 bg-slate-950 border-t border-white/10">
                <div className="flex gap-2">
                   <input type="text" placeholder="اكتب تعليقاً..." className="flex-1 bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-indigo-500" />
                   <button className="p-2 bg-indigo-600 rounded-lg text-white"><MessageSquare size={14}/></button>
                </div>
             </div>
          </div>
                ...
                {upcoming.map((evt, i) => (
                   <div key={i} className="flex items-center gap-3 p-2 hover:bg-white/5 rounded-lg transition-colors">
                      ...
                      <div className="flex-1 min-w-0">
                         ...
                         <div className="text-[10px] text-slate-500">{evt.speaker} • {evt.date}</div>
                      </div>
                   </div>
                ))}
             </div>
