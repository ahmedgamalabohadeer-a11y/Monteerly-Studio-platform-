          ...
          <div className="p-4 bg-black/40 border border-white/5 rounded-xl">
            ...
            <div className="flex gap-4">
              <button
                ...
                className={`flex-1 p-3 rounded-lg border text-xs font-bold flex flex-col items-center gap-2 ${
                  mode === 'invisible'
          ...
          <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4 animate-in slide-in-from-bottom-2">
            ...
            <div className="space-y-2 text-xs text-white">
              <div className="flex justify-between">
                <span className="text-slate-400">المسرب:</span>
                <b>{detectedLeak.user}</b>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">العنوان (IP):</span>
                <span className="font-mono">{detectedLeak.ip}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">الجهاز:</span>
                <span>{detectedLeak.device}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">وقت المشاهدة:</span>
                <span>{detectedLeak.time}</span>
              </div>
            </div>
          </div>
        )}
