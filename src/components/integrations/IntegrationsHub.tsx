    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div className="bg-[#00005c] border border-blue-900/50 rounded-2xl p-8 relative overflow-hidden group">
        <div className="absolute top-0 right-0 p-4 opacity-10">
          <Image
            src="/icons/premiere-logo.svg"
            alt="شعار Adobe Premiere Pro"
            width={128}
            height={128}
            className="w-32 h-32"
          />
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 bg-[#9999ff] text-[#00005c] font-black text-xl flex items-center justify-center rounded-lg">
              Pr
            </div>
            <h3 className="text-2xl font-bold text-white">Adobe Premiere Pro</h3>
          </div>
          <p className="text-blue-100 mb-6 leading-relaxed">
            لا تغادر برنامجك المفضل. حمل إضافة Monteerly لرفع الفيديوهات، استقبال التعليقات، ومزامنة الـ
            Markers مباشرة داخل التايم لاين.
          </p>
          <ul className="space-y-2 mb-8 text-sm text-blue-200">
            <li className="flex items-center gap-2">
              <CheckCircle size={14} className="text-green-400" /> مزامنة التعليقات كـ Markers
            </li>
            <li className="flex items-center gap-2">
              <CheckCircle size={14} className="text-green-400" /> رفع Render بضغطة زر
            </li>
            <li className="flex items-center gap-2">
              <CheckCircle size={14} className="text-green-400" /> استيراد ملفات من التخزين السحابي
            </li>
          </ul>
