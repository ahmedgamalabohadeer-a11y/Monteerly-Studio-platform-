...
import { Play, CheckCircle, MessageSquare, Download, CreditCard } from 'lucide-react';
        ...
        <div className="flex gap-4">
          ...
          {status === 'approved' && (
            <Button
              ...
              className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold gap-2 animate-pulse"
            >
              <CreditCard size={16} />
              دفع باقي المستحقات ($500)
            </Button>
          )}
            ...
            <div className="bg-slate-900 border border-white/10 rounded-xl p-6 flex gap-4">
              ...
              <div>
                <p className="text-slate-300 text-sm leading-relaxed mb-2">
                  أهلاً أستاذ خالد، قمت بتعديل الألوان في المشهد الثالث كما طلبت، وقمت
                  بموازنة الصوت. يرجى الملاحظة أن الموسيقى الآن مرخصة بالكامل. بانتظار
                  اعتمادكم الكريم.
                </p>
