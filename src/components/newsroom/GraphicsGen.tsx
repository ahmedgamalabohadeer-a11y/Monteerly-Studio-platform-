    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="bg-black rounded-xl overflow-hidden relative border border-white/10 aspect-video flex items-end">
        <Image
          ...
          alt="خلفية معاينة الجرافيك الإخباري"
          fill
        ...
        <div className="relative z-10 w-full p-8 pb-12">
          {style === 'breaking' && (
            <div className="animate-in slide-in-from-bottom-4">
              <div className="bg-red-600 text-white text-xs font-bold inline-block px-3 py-1 uppercase tracking-widest mb-0.5">
                Breaking News
              </div>
              <div className="bg-white/90 backdrop-blur text-black font-black text-2xl px-4 py-2 w-fit">{headline}</div>
              <div className="bg-black/80 backdrop-blur text-white text-sm font-bold px-4 py-1 w-fit border-l-4 border-red-600">
                {subhead}
              </div>
            </div>
          )}
          ...
          {style === 'standard' && (
            <div className="animate-in slide-in-from-left-4">
              ...
              <div className="bg-slate-900/90 text-slate-200 text-xs px-6 py-1 w-full max-w-xl rounded-br-xl border-l-4 border-blue-400">
                {subhead}
              </div>
            </div>
          )}
          ...
          {style === 'exclusive' && (
            <div className="animate-in zoom-in-95 text-center w-full flex flex-col items-center">
              <div className="bg-purple-600 text-white text-[10px] font-bold px-3 py-0.5 rounded-full mb-2 uppercase tracking-widest border border-purple-400">
                Exclusive Coverage
              </div>
