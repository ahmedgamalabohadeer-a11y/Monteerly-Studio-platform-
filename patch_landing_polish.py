      ...
      <footer className={`py-12 md:py-16 px-4 border-t relative z-20 ${isDarkMode ? 'bg-[#030305] border-white/5' : 'bg-slate-100 border-slate-200'}`}>
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-2">
             {/* الإصلاح البصري: استخدام img بدلاً من Image لملفات SVG */}
             <img src="/images/monteerly/monteerly_02_main_logo_full.svg" alt="MCOS" className="h-8 md:h-10 w-auto mb-4 opacity-90" />
...
print("✅ تمت إزالة شريط الملاحة المزدوج بنجاح!")
print("✅ تم تحرير شعار التذييل (SVG) ليعمل بكفاءة تامة!")
